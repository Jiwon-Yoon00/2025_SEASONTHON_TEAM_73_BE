...
public class GeoService {
    ...
    public Optional<GeoResult> geocodeOne(String query){
        ...
        return Optional.of(new GeoResult(display, lat, lng));
    }
