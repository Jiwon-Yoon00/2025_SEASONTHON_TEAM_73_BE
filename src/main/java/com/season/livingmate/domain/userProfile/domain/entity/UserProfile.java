package com.season.livingmate.domain.userProfile.domain.entity;

import com.season.livingmate.domain.user.domain.entity.User;
import com.season.livingmate.domain.userProfile.domain.entity.enums.*;
...
public class UserProfile extends BaseEntity {
    ...
    * */
    ...
    public void update(UserProfileUpdateReq dto, User user) {
    ...
    public void updateFromCreateDto(UserProfileCreateReq dto) {
