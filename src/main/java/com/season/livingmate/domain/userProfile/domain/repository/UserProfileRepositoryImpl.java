...
import com.season.livingmate.domain.user.domain.entity.QUser;
...
import com.season.livingmate.domain.userProfile.domain.entity.QUserProfile;
...
public class UserProfileRepositoryImpl {
    ...
    public Page<UserProfile> filterWithBoostFirst(UserFilterReq dto,
                                                  Gender gender,
                                                  Long loggedInUserId,
